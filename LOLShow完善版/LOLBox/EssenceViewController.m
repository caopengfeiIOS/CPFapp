...
{
    __weak EssenceViewController * new = self;
...
-(void)sendTwoLink
{
    [self loadDataWithHeadPath:[NSString stringWithFormat:TwoEssenceUrl,self.path]];
...
-(void)sendLink
{
    [self loadDataWithPath:[NSString stringWithFormat:EssenceUrl,1]];
}
...
//-(void)loadData
//{
//    [self loadDataWithPath:EssenceUrl];
//}
@end
